...
function poweron(){
  ...
  if(document.getElementById("power-switch").checked == false){
    ...
    document.getElementById("vm-value").value = "";
...
function vxil_ckt_sim() {
    alert("Finding Load Current (IL) across load resistance (RL) and Dependent Voltage (Vx) across Resistance (R1)");
    ...
    document.getElementById("ammeter-title").style.display = "block";
    document.getElementById("change-title").style.display = "none";
...
var vx_1, vs, r1, r2, r3, rl,Il,a,b,aa;
var tabrowindex = 0;
var arr = [];
var table;
var load1;
...
function vxil_calc(){
    ...
    // --------------------CALCULATION OF Vx FOR INSTANCE 1--------------------
    aa = 4 * parseFloat(r1);
    a = (parseFloat(r1) * (parseFloat(r2) + parseFloat (r3) + parseFloat(rl)));
    b = ((parseFloat(r3) + parseFloat(rl)) * (parseFloat(aa) + parseFloat(r2)) + (parseFloat(r1) * parseFloat(r2)));
    vx_1 = (parseFloat(vs) * (parseFloat(a) / parseFloat(b)));
    document.getElementById("vm-value").value = vx_1.toPrecision(3);
    // --------------------CALCULATION OF Il FOR INSTANCE 1--------------------
    Il = ((parseFloat(vs) - parseFloat(vx_1)) / (parseFloat(r3) + parseFloat(rl)));
    ...
    arr[3] = document.getElementById("vm-value").value;
...
function vxrth_ckt_sim() {
    alert("Finding Thevenin Resistance and Dependent Voltage (Vx) across Resistance (R1)");
    document.getElementById("main_ckt").style.display = "none";
...
var vx_2,vdc,bb,c,d,e,idc,rth,vs,r1,r2,r3,rl;
var tabrowindex1 = 0;
var arr1 = [];
var table1;
var load2;
...
function vxrth_calc(){
    ...
    // --------------------CALCULATION OF Vx FOR INSTANCE 2--------------------
    bb = 4 * (parseFloat(r1) * parseFloat(r3));
    c = (parseFloat(r1) * parseFloat(r2));
    d = (parseFloat(r2) * parseFloat(r3));
    e = -(parseFloat(vdc));
    vx_2 = (parseFloat(e) * ((parseFloat(c))/(parseFloat(c) + parseFloat(d) + parseFloat(bb))));
    document.getElementById("vm-value").value = vx_2.toPrecision(3);
    // --------------------CALCULATION OF Idc FOR INSTANCE 2--------------------
    idc = ((parseFloat(vdc) + parseFloat(vx_2))/parseFloat(r3));
    // --------------------CALCULATION OF Rth FOR INSTANCE 2--------------------
    rth = (parseFloat(vdc)/parseFloat(idc));
    ...
    arr1[2] = document.getElementById("vm-value").value;
...
function vxvth_ckt_sim() {
    alert("Finding Thevenin Voltage and Dependent Voltage (Vx) across Resistance (R1)");
    document.getElementById("main_ckt").style.display = "none";
    document.getElementById("instance-1-sim").style.display = "none";
    document.getElementById("instance-2-sim").style.display = "none";
    ...
    document.getElementById("rth-value").style.display = "none";
    document.getElementById("rth-label").style.display = "none";
    document.getElementById("ammeter-title").style.display = "none";
    document.getElementById("change-title").style.display = "block";
    document.getElementById("instance-5-text").style.display = "none";
    document.getElementById("input-fields-3").style.marginTop = "0vw";
}

var vx_3,vs,r1,r2,r3,cc,vth;
var tabrowindex2 = 0;
var arr2 = [];
var table2;
var load3;
...
function vxvth_calc(){
    ...
    // --------------------CALCULATION OF Vx FOR INSTANCE 3--------------------
    cc = 4 * parseFloat(r1);
    vx_3 = (parseFloat(vs) * ((parseFloat(r1))/(parseFloat(r2)+parseFloat(cc))));
    document.getElementById("vm-value").value = vx_3.toPrecision(3);
    // --------------------CALCULATION OF Vth FOR INSTANCE 3--------------------
    vth = (parseFloat(vs) - parseFloat(vx_3));
    ...
    arr2[2] = document.getElementById("vm-value").value;
